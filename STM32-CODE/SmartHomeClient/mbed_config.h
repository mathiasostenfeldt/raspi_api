...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 "Aakjaersvej3012"                                                                                // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 WPA2                                                                                             // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     "Hytten"                                                                                         // set by application[*]
...
#define MBEDTLS_MPI_MAX_SIZE                                                  1024                                                                                             // defined by application
#define MBEDTLS_MPI_WINDOW_SIZE                                               1                                                                                                // defined by application
